...
public class AESAlgorithm {
    ...
    private static final String SECRET_KEY_2 = "0987654321098765";
 
    private IvParameterSpec ivParameterSpec;
    private SecretKeySpec secretKeySpec;
    private Cipher cipher;
 
    public AESAlgorithm() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
