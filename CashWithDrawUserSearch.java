...
public class CashWithDrawUserSearch extends JFrame implements ActionListener{
			...
			if(source==btnFindUser){
		        ...
		        log.addWindowListener(new java.awt.event.WindowAdapter() {
		            ...
		            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		        		...
		        		CashWithDrawUserSearch log1=new CashWithDrawUserSearch();
		        		Dimension dim= Toolkit.getDefaultToolkit().getScreenSize();
		        		//this.setLocation(x, y);
		        		log1.setLocation(0,0);
		        		log1.setSize(dim.width,dim.height);

		        		log1.setTitle("CashWithDraw-User-Search");
